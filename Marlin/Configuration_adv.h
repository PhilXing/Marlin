...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN SERVO1_PIN //D6  // Set a custom pin for the controller fan
...
#define Z_HOME_BUMP_MM X_HOME_BUMP_MM // deltas need the same for all three axes
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_RETRACT_LENGTH       5  // (mm) Unload initial retract length.
